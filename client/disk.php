...
<body>
    ...
    <div class="products-container">
        <div class =products>
            <div class="product">
                ...
                <h3>Rack 2,5" SATA</h3>
                <h3>690 DA</h3>
                <button onclick="addToCart(71)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Rack 2,5" SATA NHD18</h3>
                <h3>950 DA</h3>
                <button onclick="addToCart(72)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Rack 2,5" IDE Empreinte Digitale 25UK</h3>
                <h3>590 DA</h3>
                <button onclick="addToCart(73)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Rack 3,5" Interne IDE MR001</h3>
                <h3>290 DA</h3>
                <button onclick="addToCart(74)">Ajouter au panier</button>
            </div>
        </div>
    </div> 
    </main>
    <script>
        function addToCart(productId) {
            window.location.href = `disk.php?addToCart=${productId}`;
        }
    </script>
