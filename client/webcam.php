...
<body>
    ...
    <div class="products-container">
        <div class =products>
            <div class="product">
                ...
                <h3>Webcam B002/024/075/045 3MPS</h3>
                <h3>490 DA</h3>
                <button onclick="addToCart(61)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Webcam 31/49/78/95/92</h3>
                <h3>490 DA</h3>
                <button onclick="addToCart(62)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>WebCam WCED006/091/69/087/004</h3>
                <h3>590 DA</h3>
                <button onclick="addToCart(63)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>WebCam  WCH288</h3>
                <h3>690 DA</h3>
                <button onclick="addToCart(64)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>WebCam  W097 3MPS</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(65)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>WebCam YH25/22/ED820   8MPS </h3>
                <h3>890 DA</h3>
                <button onclick="addToCart(66)">Ajouter au panier</button>
            </div>
        </div>
    </div> 
    </main>
    <script>
        function addToCart(productId) {
            window.location.href = `webcam.php?addToCart=${productId}`;
        }
    </script>
