...
<body>
    ...
    <div class="products-container">
        <div class =products>
            <div class="product">
                ...
                <h3>Lampe USB 896-3</h3>
                <h3>350 DA</h3>
                <button onclick="addToCart(120)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Lampe USB 898A</h3>
                <h3>550 DA</h3>
                <button onclick="addToCart(121)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Support ventilateur Laptop 8503</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(122)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Support ventilateur Laptop 769</h3>
                <h3>890 DA</h3>
                <button onclick="addToCart(123)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Copy Holder Click Type</h3>
                <h3>15 DA</h3>
                <button onclick="addToCart(124)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Housse de protection écran TFT22"</h3>
                <h3>120 DA</h3>
                <button onclick="addToCart(125)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Support tablette LS100</h3>
                <h3>390 DA</h3>
                <button onclick="addToCart(126)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Support tablette P6</h3>
                <h3>490 DA</h3>
                <button onclick="addToCart(127)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Hub USB 4Ports H2042/2044</h3>
                <h3>190 DA</h3>
                <button onclick="addToCart(128)">Ajouter au panier</button>
            </div>
        </div>
    </div> 
    </main>
    <script>
        function addToCart(productId) {
            window.location.href = `accessoire.php?addToCart=${productId}`;
        }
    </script>
