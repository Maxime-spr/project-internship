...
<body>
    ...
    <div class="products-container">
        <div class =products>
            <div class="product">
                ...
                <h3>Chargeur universel Allume Cigare 100W</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(87)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Chargeur universel Allume Cigare 120W</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(88)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Chargeur Universel 90W (614)</h3>
                <h3>1390 DA</h3>
                <button onclick="addToCart(89)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Chargeur Universel 120w (616)</h3>
                <h3>1390 DA</h3>
                <button onclick="addToCart(90)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product1.jpg" alt="Produit 1">
                <h3>Chargeur Universel 90W Auto (615)</h3>
                <h3>1890 DA</h3>
                <button onclick="addToCart(91)">Ajouter au panier</button>
            </div>
    ...
    <script>
        function addToCart(productId) {
            window.location.href = `chargeur.php?addToCart=${productId}`;
        }
    </script>
