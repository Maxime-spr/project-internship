...
<body>
    ...
    <div class="products-container">
        <div class =products>
            <div class="product">
                ...
                <h3>Haut Parleur LJ-800A Sacoche</h3>
                <h3>390 DA</h3>
                <button onclick="addToCart(101)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Haut Parleur LJ-824A</h3>
                <h3>590 DA</h3>
                <button onclick="addToCart(102)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Haut Parleur LJ-858A</h3>
                <h3>590 DA</h3>
                <button onclick="addToCart(103)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Haut Parleur LJ-805</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(104)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Haut parleur mini speaker</h3>
                <h3>390 DA</h3>
                <button onclick="addToCart(105)">Ajouter au panier</button>
            </div>
            <div class="product">
                <img src="./img/product3.jpg" alt="Produit 3">
                <h3>Haut Parleur LJ-668A</h3>
                <h3>790 DA</h3>
                <button onclick="addToCart(106)">Ajouter au panier</button>
            </div>
        </div>
    </div> 
    </main>
    <script>
        function addToCart(productId) {
            window.location.href = `speaker.php?addToCart=${productId}`;
        }
    </script>
